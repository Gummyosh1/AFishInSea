...
public class FishBios : MonoBehaviour
{
    [NonSerialized] public string[] EastBlueNormalFish =
    {
        "The story of this world is said to be contained in the fish of the vast oceans... come back in a future update for the stories that each one tells!",
        "Charcoal Karp",
        "Tigerfish",
        "Sungazer",
        "Petra",
    ...
    public string[][][] bioLists = new string[5][][];
    ...
    public void Start()
    {
        ...
        bioLists[0] = EastBlueHolder;
        bioLists[1] = PurpleHolder;
        bioLists[2] = LavaHolder;
        bioLists[3] = AllBlueHolder;
        bioLists[4] = EliteEightHolder;
    }
}
